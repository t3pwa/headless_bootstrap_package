...
// t3lib_extMgm::addStaticFile($_EXTKEY, '/Configuration/TypoScript/', 'Configuration TypoScript');
/*
call_user_func(
    function () {
        ...
        $GLOBALS['TYPO3_CONF_VARS']['FE']['contentRenderingTemplates'][] = 'headless_bootstrap_package/Configuration/TypoScript/';
